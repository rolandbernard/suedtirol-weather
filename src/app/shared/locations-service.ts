...
export class LocationsService {
    locationToStationMap = {
        ...
        "mun5D4D46A9754B4332B73B0274380617E9": "86600MS",
        ...
        "mun50FCFD4334A04DB087C1FD10ED864018": "82910MS",
        ...
        "mun81A76A9381CD4A5D92C5DA51F0E9CEEB": "42700MS",
    ...
    async getLocationIdsByCord(lat: number, long: number): Promise<string[]> {
        const locations: any[] = await this.http.get<any[]>(`http://tourism.opendatahub.bz.it/api/Municipality?elements=0&visibleinsearch=false&latitude=${lat}&longitude=${long}&radius=5000`).toPromise();
            return locations.map((location) => "mun" + location.Id);
    }
